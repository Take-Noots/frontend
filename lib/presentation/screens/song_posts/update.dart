        ...
        child: SafeArea(
          child: LayoutBuilder(
            builder: (context, constraints) {
              // Make the content scrollable and respect the keyboard inset so the TextField doesn't cause
              // a bottom overflow when the keyboard or an overlapping bottom player is visible.
                  ...
                  child: IntrinsicHeight(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget.post.albumImage != null &&
                            widget.post.albumImage!.isNotEmpty)
                          Container(
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  'Write your thoughts about this song...',
                              hintStyle: TextStyle(
                        ...
                        // push the button to the bottom when there's extra space
                        const Spacer(),
